...
settings = Settings()
logger.debug(f"[DEBUG] Loaded Settings: Provider={settings.DEFAULT_LLM_PROVIDER}, EmbeddingModel={settings.EMBEDDING_MODEL_NAME}, ChromaDB Cloud Tenant={settings.CHROMA_TENANT}")
